...
tk.title("TETRIS")
tk.resizable(0,0) # flexible (None, None)
...
game_sc = Canvas(tk, width=W*TILE+1, height=H*TILE+1, bg="gold", highlightthickness=0)
game_sc.place(x=20, y=20, anchor=NW)

img1 = PhotoImage(file='ice.png')   # kuva ei skaalaudu
sc.create_image(0, 0, anchor=NW, image=img1)

img2 = PhotoImage(file='tree.png')  
game_sc.create_image(0, 0, anchor=NW, image=img2)
...
sc.create_text(540,20,text="COOL", font=(('Phosphate Solid', '65', 'bold')),fill="black", anchor=NW)  
sc.create_text(505,60,text="TETRIS", font=("Phosphate Solid", '85', 'bold'),fill="red", anchor=NW)
sc.create_text(535,780,text="SCORE:", font=("Phosphate", 45),fill="black", anchor=NW)
_score = sc.create_text(550,840,text=str(score), font=("Phosphate Solid", 45),fill="black", anchor=NW)
sc.create_text(525,650,text="RECORD:", font=("Phosphate", 45),fill="black", anchor=NW)
_record = sc.create_text(550,710,text=record, font=("Phosphate Solid", 45),fill="red", anchor=NW)
